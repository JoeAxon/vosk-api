...
const libvosk = {
  vosk_model_new: ref.func("vosk_model_new", "VoskModel *", ["string"]),
  vosk_model_free: ref.func("vosk_model_free", "void", ["VoskModel *"]),
  vosk_spk_model_new: ref.func("vosk_spk_model_new", "VoskSpkModel *", [
    "string",
  ]),
  vosk_spk_model_free: ref.func("vosk_spk_model_free", "void", [
    "VoskSpkModel *",
  ]),
  vosk_recognizer_new: ref.func("vosk_recognizer_new", "VoskRecognizer *", [
    "VoskModel *",
    "float",
  ]),
  vosk_recognizer_new_spk: ref.func(
    "vosk_recognizer_new_spk",
    "VoskRecognizer *",
    ["VoskModel *", "float", "VoskSpkModel *"]
  ),
  vosk_recognizer_new_grm: ref.func(
    "vosk_recognizer_new_grm",
    "VoskRecognizer *",
    ["VoskModel *", "float", "string"]
  ),
  vosk_recognizer_set_spk_model: ref.func(
    "vosk_recognizer_set_spk_model",
    "void",
    ["VoskRecognizer *", "VoskSpkModel *"]
  ),
  vosk_recognizer_set_max_alternatives: ref.func(
    "vosk_recognizer_set_max_alternatives",
    "void",
    ["VoskRecognizer *", "int"]
  ),
  vosk_recognizer_set_words: ref.func("vosk_recognizer_set_words", "void", [
    "VoskRecognizer *",
    "bool",
  ]),
  vosk_recognizer_set_partial_words: ref.func(
    "vosk_recognizer_set_partial_words",
    "void",
    ["VoskRecognizer *", "bool"]
  ),
  vosk_recognizer_accept_waveform: ref.func(
    "vosk_recognizer_accept_waveform",
    "bool",
    ["VoskRecognizer *", "short *", "int"]
  ),
  vosk_recognizer_result: ref.func("vosk_recognizer_result", "string", [
    "VoskRecognizer *",
  ]),
  vosk_recognizer_partial_result: ref.func(
    "vosk_recognizer_partial_result",
    "string",
    ["VoskRecognizer *"]
  ),
  vosk_recognizer_final_result: ref.func(
    "vosk_recognizer_final_result",
    "string",
    ["VoskRecognizer *"]
  ),
  vosk_recognizer_reset: ref.func("vosk_recognizer_reset", "void", [
    "VoskRecognizer *",
  ]),
  vosk_recognizer_free: ref.func("vosk_recognizer_free", "void", [
    "VoskRecognizer *",
  ]),
  vosk_set_log_level: ref.func("vosk_set_log_level", "void", ["int"]),
};
...
class Recognizer {
  ...
  constructor(param) {
    ...
    this.handle = hasOwnProperty(param, "speakerModel")
      ? libvosk.vosk_recognizer_new_spk(
          model.handle,
          sampleRate,
